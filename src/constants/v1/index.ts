...
const V1_FACTORY_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MOONRIVER]: NON_EXISTENT_ADDRESS,
  [ChainId.FANTOM]: NON_EXISTENT_ADDRESS,
  [ChainId.SHIDEN]: NON_EXISTENT_ADDRESS,
  [ChainId.IOTEX]: NON_EXISTENT_ADDRESS,
  [ChainId.HARMONY]: NON_EXISTENT_ADDRESS,
  [ChainId.CRONOS]: NON_EXISTENT_ADDRESS,
  [ChainId.OKEX]: NON_EXISTENT_ADDRESS,
  [ChainId.MULTIVAC]: NON_EXISTENT_ADDRESS,
  [ChainId.METIS_NETWORK]: NON_EXISTENT_ADDRESS,
  [ChainId.MOONBEAM]: NON_EXISTENT_ADDRESS,
}
