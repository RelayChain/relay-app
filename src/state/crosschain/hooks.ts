...
import { CrosschainState } from './reducer'
...
export function useCrosschainActionHandlers(): {
...
// from the current crosschain inputs, compute the best trade and return it.
export function useDerivedCrosschainInfo(): {
...
export function queryParametersToCrosschainState(parsedQs: ParsedQs): CrosschainState {
...
// updates the crosschain state to use the defaults for a given network
