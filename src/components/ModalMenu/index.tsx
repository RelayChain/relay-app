    ...
    return (
        <Modal isOpen={isOpen} onDismiss={onDismiss}>
            <ModalContainer>
                ...
                <MenuItem id={`bridge-nav-link`} to={'/cross-chain-bridge-transfer'} onClick={() => redirectTo('/cross-chain-bridge-transfer')}>
                    <IconLink>
                ...
                <MenuItem id={`stake-nav-link`} to={'/single-sided-staking'} onClick={() => redirectTo('/single-sided-staking')}>
                    <IconLink>
